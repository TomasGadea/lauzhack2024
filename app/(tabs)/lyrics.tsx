...
import LyricsData from "@/constants/lyricsData.json";
import Animated, {
    cancelAnimation,
    Easing,
    useAnimatedStyle,
            ...
            transform: [
                {
                    translateY:
                        lyricsScrollValue.value > halfScrollComponentHeight
                            ? -lyricsScrollValue.value +
                              halfScrollComponentHeight
                            : 0,
                },
            ],
        };
